...
public:
    ...
    void check_failure_condition();
    void check_success_condition(Entity* platforms, int platform_count);
    ...
    // Setter for platform type
    void set_platform_type(PlatformType type) {
        platform_type = type;
    }
